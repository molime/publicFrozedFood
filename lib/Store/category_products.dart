...
class _CategoryProductsState extends State<CategoryProducts>
  ...
  void setTabController() {
    _tabController = TabController(
      length: Provider.of<CategoryData>(context, listen: false).categoryCount,
      vsync: this,
      initialIndex:
          Provider.of<CategoryData>(context, listen: false).indexSelected,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: List<Tab>.generate(
              Provider.of<CategoryData>(context).categoryCount,
              (index) {
                return Tab(
                  icon: Icon(
                    Icons.category,
        ...
        body: TabBarView(
          controller: _tabController,
          children: List<CustomScrollView>.generate(
            Provider.of<CategoryData>(context).categoryCount,
            (index) {
                ...
                slivers: [
                  ...
                  StreamBuilder<QuerySnapshot>(
                    stream: EcommerceApp.firestore
                        ...
                        .where(
                          "categories",
                          arrayContains: Provider.of<CategoryData>(context)
                              .categories[index]
                              .uid,
                        )
                        .limit(15)
